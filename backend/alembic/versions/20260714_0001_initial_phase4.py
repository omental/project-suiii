...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("height_cm", sa.Numeric(6, 2), nullable=False, server_default="170"),
        sa.Column("starting_weight_kg", sa.Numeric(6, 2), nullable=False, server_default="70"),
        sa.Column("target_weight_min_kg", sa.Numeric(6, 2), nullable=False, server_default="65"),
        sa.Column("target_weight_max_kg", sa.Numeric(6, 2), nullable=False, server_default="70"),
        sa.Column("starting_waist_in", sa.Numeric(6, 2), nullable=False, server_default="34"),
        sa.Column("target_waist_in", sa.Numeric(6, 2), nullable=False, server_default="32"),
        sa.Column("calorie_target", sa.Integer(), nullable=False, server_default="2000"),
        sa.Column("protein_target_g", sa.Integer(), nullable=False, server_default="120"),
        sa.Column("water_target_ml", sa.Integer(), nullable=False, server_default="2500"),
        sa.Column("timezone", sa.String(length=64), nullable=False, server_default="Asia/Dhaka"),
